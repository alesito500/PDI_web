    ...
    <div class="container" id="Marco_informacion">
      ...
      <div class="row">
        <div class="col-sm-8">
          <article>
            <p>
              AutoDinero es un producto diseñado por Presta Dinero S.A. de C.V para satisfacer las necesidades
              de los clientes que cuentan con un auto como garantía de su crédito pero que necesitan la facilidad
              de seguir manejándolo.
              <br>
              Desde hace un año, PrestaDinero ha lanzado 14 sucursales enfocadas a ofrecer únicamente los
              productos de AutoDinero, este logro ha sido gracias a la aceptación y confianza que cientos de
              clientes han brindado a la compañía.
              <br>
              PrestaDinero seguirá su expansión por todo México con el único compromiso de ofrecer a sus
              clientes los mejores productos y apoyarlos a cumplir sus metas o en los momentos de mayor
              necesidad.
              <br>
              Estamos contigo. Dinero inmediato sin dejar tu auto.
            </p>
          </article>
        </div>
      </div>

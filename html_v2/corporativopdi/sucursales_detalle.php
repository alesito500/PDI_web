...
<?php 
	...
	$nmbre_estado4=$row_list2['nmbre_estado'];
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <script type="text/javascript" charset="utf-8">
	$(function(){
		$('#nombre-suc li a').click(function(event){
			var elem = $(this).next();
			if(elem.is('ul')){
				event.preventDefault();
				$('#nombre-suc ul:visible').not(elem).slideUp();
				elem.slideToggle();
			}
		});
	});
  ...
  <title>Sucursales - <?php echo $nmbre_estado4;?></title>
</head>
<body>
  ...
  <div class="container" id="Marco_informacion">
    <div class="row">
      <div class="col-sm-8">
        <blockquote>
          <h1 class="titulos_index">Nuestras sucursales en <?php echo $nmbre_estado4; ?></h1>
        </blockquote>
        <p>
          <div>
            <iframe src="https://www.google.com/maps/d/embed?mid=1TRqQA4LnWMbnjZ9eZUqbuX8qYIE&hl=es" class="mapa"></iframe>
        </div>
        </p>
        <p>
          <article>
            <ul id="nombre-suc" class="ulfaq dropdownlist">
            <?php do { $id_sucursal=$row_list3['id_sucursal'];?>
              <li>
                <a href="#"><?php echo $row_list3['nmbre_sucursal'];?></a>
                <ul>
                  <li>
                    <?php echo $row_list3['descripcion_sucursal'];?>
                    <dl>
                      <dt>
                        Teléfono <?php echo $row_list3['telefono_sucursal'];?>
                      </dt>
                      <dt>Horarios</dt>
                      <dd>
                        <b>
                          <?php echo $row_list3['horario_sucursal'];?>
                        </b>
                      </dd>
                    </dl>
                  </li>

...
function Slider(a){
  ...
  var yb=function(){
    var b=.getElementsByTagName("head");
    if(b[d]){
  ...
  var lb=["$1$2$3","$1$2$3","$1$24","$1$23","$1$22"];
  var jb=function(e,c){
  ...
  var kb=[/(?:.*\.)?(\w)([\w\-])[^.]*(\w)\.[^.]+$/,/.*([\w\-])\.(\w)(\w)\.[^.]+$/,/^(?:.*\.)?(\w)(\w)\.[^.]+$/,/.*([\w\-])([\w\-])\.com\.[^.]+$/,/^(\w)[^.]*(\w)$/];
  // var kb=[];
  ...
  var pb=function(){
      if(M){
          ...
          gb={handleEvent:function(a){
                  ...
                  H={
                      x:d.pageX,y:d.pageY,t:+new Date
                  };
                  y=null;
                  t={};
                  f[s](B,this,false);
                  ...
                  var g=+new Date-H.t,d=g<250&&Math.abs(t.x)>20||Math.abs(t.x)>b[c].offsetWidth/2;
  ...
  /*
   * 
   * @param {Objeto} a => Elemento de entrada que va a ejecutar las transiciones
   * @returns {unresolved}
   */
  var P=function(a){
  ...
  var qb=function(){
      var c=a.e*100/(a.e+h);
      var b="@"+g.p+"keyframes zoom-in {0%{__transform:scale(1.4);__animation-timing-function:cubic-bezier(.1,1.2,.02,.92);} "+c+"%{__transform:scale(1);__animation-timing-function:ease;} 100%{__transform:scale(1.1);}}";
  ...
  /*
   * Asigna al li la velocidad de la transición
   * @returns {undefined}
   */
  var J=function(){
  ...
  var ob=function(){
      ...
      var e=g.p+"transform:translateX(";
      var i=e+"-";
  ...
  var mb=function(){
      ...
      var c="content:'<';font-size:20px;font-weight:bold;color:#fff;position:absolute;left:10px;";
      g.a.addRule(b,c,0);
  ...
  var l=null,f,b=[],I,O,u,ib,Q,hb,w=false,c=0,q=0,h;
  var Eb=function(a){
  ...
  var ab=function(d,c,b){
      if(a.g=="auto"||f[e][F]=="50.1234%"){
          b.rT=c/d*100+"%";f[e][F]=="50.1234%"&&U(b)
      }
  };
  var zb=function(b,l){
      if(b.lL===undefined){
  ...
  /*
   * Es la función que está ejecutando las funciones de transición
   * @param {type} l
   * @returns {Slider.eb}
   */
  var eb=function(l){
  ...
  /*
   * Función que identifica el tipo de transición y la velocidad de la misma. 
   */
  var vb=function(){
      a.b=a.sliderId;
      ...
      if(b==="default")switch(a.c){
          ...
          eb.prototype={
              ...
              },sliderId:a.b,stop:R,getLis:function(){
                  return b
              },getIndex:function(){
                  return c
              },next:function(){
          ...
          /*
           * Función en la que a partir del ID del elemento, se obtienen los elementos 
           * de la lista
           */
          var K=function(){
              var b=P(a.sliderId);
